...
export default function Preloader({ onComplete }: { onComplete?: () => void }) {
  ...
  return (
    <div
      ...
      className={`preloader-overlay ${loaded ? 'preloader-loaded' : ''}`}
      aria-hidden={loaded}
      role="dialog"
      aria-modal="true"
      aria-label="Welcome to Shaik Balaji Mahammad Rafi's Portfolio"
    >
      <div className="mac-hello-container">
        <svg
          className="apple-hello-svg"
          viewBox="-120 -20 2520 760"
          fill="none"
        ...
        >
          <g transform="scale(1, -1) translate(0, -728.156)">
            <motion.path
              ...
              transition={{
                duration: 7.3,
                times: [0, 0.075, 0.595, 0.669, 0.676, 1],
                ease: 'easeInOut'
              }}
            />
            ...
            <motion.path
              ...
              animate={{
                ...
                pathOffset: [0, 0, 0, 0, 0, 1, 1]
              }}
              transition={{
                duration: 7.3,
                times: [0, 0.074, 0.075, 0.392, 0.669, 0.986, 1],
                ease: 'easeInOut'
              }}
            />
          </g>
